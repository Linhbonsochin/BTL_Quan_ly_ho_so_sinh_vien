...
/*
========================================
 Chức năng: Các hàm xử lý khoa/phòng ban (CRUD, lấy danh sách, thêm, sửa, xóa)
========================================
*/
...
// Lấy danh sách khoa cho dropdown (giống getAllDepartments nhưng chỉ trả về id và tên)
function getAllDepartmentsForDropdown() {
    global $conn;
