...
function getAllClasses()
{
    ...
    $sql = "SELECT c.id, c.class_code, c.class_name, c.department_id, d.department_name " .
        "FROM classes c LEFT JOIN departments d ON c.department_id = d.id ORDER BY c.id DESC";
