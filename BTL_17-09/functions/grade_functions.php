...
function getAllGrades()
{
    ...
    try {
        ...
        // If the subjects table (or others) doesn't exist, return empty list instead of crashing.
        // Optionally log $ex->getMessage() somewhere.
    }
...
function getGradeById($id)
{
    ...
    try {
        ...
        // table missing or other DB error — return null
    }
