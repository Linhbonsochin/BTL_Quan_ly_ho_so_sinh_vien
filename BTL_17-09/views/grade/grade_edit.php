...
>
            <div class="mb-3">
                ...
                <input type="number" step="0.01" min="0" max="10" name="attendance_score" id="attendance_score" class="form-control" value="<?php echo htmlspecialchars($grade['attendance_score']); ?>" required oninput="calcTotalScore()">
            </div>
            <div class="mb-3">
                <label for="midterm_score" class="form-label">Điểm giữa kỳ</label>
                <input type="number" step="0.01" min="0" max="10" name="midterm_score" id="midterm_score" class="form-control" value="<?php echo htmlspecialchars($grade['midterm_score']); ?>" required oninput="calcTotalScore()">
            </div>
            <div class="mb-3">
                <label for="final_score" class="form-label">Điểm cuối kỳ</label>
                <input type="number" step="0.01" min="0" max="10" name="final_score" id="final_score" class="form-control" value="<?php echo htmlspecialchars($grade['final_score']); ?>" required oninput="calcTotalScore()">
            </div>
            <div class="mb-3">
                <label for="total_score" class="form-label">Điểm tổng kết</label>
                <input type="number" step="0.01" min="0" max="10" name="total_score" id="total_score" class="form-control" value="<?php echo htmlspecialchars($grade['total_score']); ?>" required readonly>
            </div>
            <script>
