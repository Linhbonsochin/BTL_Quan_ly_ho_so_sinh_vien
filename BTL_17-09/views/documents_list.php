...
<body>
    ...
    <div class="container my-4">
        ...
        <?php if (empty($items)): ?>
            <div class="alert alert-info">Chưa có văn bản/biểu mẫu nào.</div>
        <?php else: ?>
            <div class="list-group">
                <?php foreach($items as $it): ?>
                    <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-start" href="static_view.php?type=document&id=<?php echo $it['id']; ?>">
                        <div>
