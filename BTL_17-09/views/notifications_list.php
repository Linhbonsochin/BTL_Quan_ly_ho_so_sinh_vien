...
$all = getStaticsByType('notification');
        ...
        <?php else: ?>
            <div class="list-group">
                <?php foreach($items as $it): ?>
                    <a class="list-group-item list-group-item-action d-flex justify-content-between align-items-start" href="static_view.php?type=notification&id=<?php echo $it['id']; ?>">
                        <div>
