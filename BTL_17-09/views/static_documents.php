...
$allItems = getStaticsByType('document');
...
<head>
    ...
    <title>Quản lý văn bản / biểu mẫu</title>
    ...
    <div class="d-flex">
        ...
        <div class="flex-grow-1 dashboard-main">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h3 class="m-0">Quản lý văn bản / biểu mẫu</h3>
                <div>
            ...
            <div class="mb-3">
                <a href="document/static_documents_create.php" class="btn btn-primary">Thêm văn bản/biểu mẫu</a>
            </div>
            <div class="mb-3">
                <form method="GET" action="static_documents.php" class="p-3 bg-white rounded-3 shadow-sm">
                    <div class="d-flex gap-2 align-items-center">
                        <input type="search" name="q" class="form-control" placeholder="Tìm theo tiêu đề"
                            value="<?php echo htmlspecialchars($q); ?>">

                        <input type="date" name="date_from" class="form-control" style="max-width:160px;"
                            value="<?php echo htmlspecialchars($dateFrom); ?>" title="Từ ngày">
                        <input type="date" name="date_to" class="form-control" style="max-width:160px;"
                            value="<?php echo htmlspecialchars($dateTo); ?>" title="Đến ngày">

                        <button class="btn btn-primary">Tìm kiếm</button>
                        <a class="btn btn-outline-secondary" href="static_documents.php">Reset</a>
                    </div>
            ...
            <div class="card card-ghost p-3">
                ...
                <form id="bulkForm" method="POST" action="/BTL_17-09/handle/static_process.php">
                                    ...
                                    foreach ($items as $i => $r): ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php endif; ?>
                                                <a class="text-primary" href="document/static_documents_edit.php?id=<?php echo $r['id']; ?>" title="Sửa"><i class="fa fa-pencil"></i></a>
                    ...
                    <!-- Pagination handled below (notifications-style) -->
            ...
            <nav aria-label="Page navigation">
                <ul class="pagination justify-content-center">
                    ...
                    if ($endPage > $totalPages) {
                        $endPage = $totalPages;
                        $startPage = max(1, $endPage - $visible + 1);
                    }
                    ?>
                    <li class="page-item <?php if ($page <= 1)
                        echo 'disabled'; ?>"><a class="page-link"
                            href="<?php echo $buildUrl(1); ?>">«</a></li>
                    <li class="page-item <?php if ($page <= 1)
                        echo 'disabled'; ?>"><a class="page-link"
