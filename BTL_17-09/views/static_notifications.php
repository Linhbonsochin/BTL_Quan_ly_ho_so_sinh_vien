...
// populate classes & departments for filters

$q = isset($_GET['q']) ? trim($_GET['q']) : '';
$dateFrom = isset($_GET['date_from']) ? trim($_GET['date_from']) : '';
$dateTo = isset($_GET['date_to']) ? trim($_GET['date_to']) : '';
$allItems = getStaticsByType('notification');
...
// (class/department filters removed)
    ...
    <div class="d-flex">
        ...
        <div class="flex-grow-1 dashboard-main">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h3 class="m-0">Quản lý thông báo</h3>
                <div>
            ...
            <div class="mb-3">
                <a href="notifications/static_notifications_create.php" class="btn btn-primary">Thêm thông báo</a>
            </div>
            <div class="mb-3">
                <form method="GET" action="static_notifications.php" class="p-3 bg-white rounded-3 shadow-sm">
                    <div class="d-flex gap-2 align-items-center">
                        ...
                        <a class="btn btn-outline-secondary" href="static_notifications.php">Reset</a>
                    </div>
                </form>
                <div class="mt-2 text-muted">Kết quả: <?php echo $total; ?></div>
            </div>
                ...
                <form id="bulkForm" method="POST" action="/BTL_17-09/handle/static_process.php">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" style="text-align:center;">
                            <thead>
                                <tr>
                                    <th class="bulk-col d-none" style="width:40px;"><input type="checkbox"
                                            id="selectAllHeader" class="form-check-input"></th>
                                    <th>STT</th>
                                    <th>Tiêu đề</th>
                                    <th>Ngày</th>
                                    <th>Xuất bản</th>
                                ...
                                <?php else:
                                    foreach ($items as $i => $r): ?>
                                        <tr>
                                            ...
                                            <td><a
                                                    href="../static_view.php?type=notification&id=<?php echo $r['id']; ?>"><?php echo htmlspecialchars($r['title']); ?></a>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <?php endif; ?>
                                                <a class="text-primary" href="notifications/static_notifications_edit.php?id=<?php echo $r['id']; ?>" title="Sửa"><i class="fa fa-pencil"></i></a>
                                                <a class="text-danger ms-2"
                                                    href="/BTL_17-09/handle/static_process.php?delete=1&id=<?php echo $r['id']; ?>"
                                                    onclick="return confirm('Xóa?')" title="Xóa"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                    ...
                    <!-- Pagination (moved below like grade.php) -->
