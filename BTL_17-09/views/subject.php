                        ...
                        <table class="table table-bordered" style="text-align: center;">
                            ...
                            <tbody>
                                <?php if (empty($subjects)): ?>
                                    <tr>
                                        <td colspan="5" class="text-center p-4">Chưa có môn học</td>
                                    </tr>
                                <?php else:
                                    foreach ($subjects as $i => $s): ?>
                                        <tr>
                                            ...
                                            <td class="table-actions">
                                                <a href="subject/subject_edit.php?id=<?php echo $s['id']; ?>"
                                                    class="text-primary" title="Sửa"><i class="fa fa-pencil"
                                                        aria-hidden="true"></i></a>
                                                <a href="../handle/subject_process.php?action=delete&id=<?php echo $s['id']; ?>"
                                                    class="text-danger ms-2" onclick="return confirm('Xóa môn này?')"
